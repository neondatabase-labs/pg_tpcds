...
int mk_w_catalog_page(void *info_arr, ds_key_t index) {
  ...
  loader.start()
      .addItem(r->cp_catalog_page_sk)
      .addItem(r->cp_catalog_page_id)
      .addItemKey(r->cp_start_date_id)
      .addItemKey(r->cp_end_date_id)
      .addItem(r->cp_department)
      .addItem(r->cp_catalog_number)
      .addItem(r->cp_catalog_page_number)
      .addItem(r->cp_description)
      .addItem(r->cp_type)
      .end();
