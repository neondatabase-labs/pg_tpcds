...
int mk_w_web_page(void *info_arr, ds_key_t index) {
  ...
  loader.start()
      .addItemKey(r->wp_page_sk)
      .addItem(r->wp_page_id)
      .addItemDate(r->wp_rec_start_date_id)
      .addItemDate(r->wp_rec_end_date_id)
      .addItemKey(r->wp_creation_date_sk)
      .addItemKey(r->wp_access_date_sk)
      .addItemBool(r->wp_autogen_flag != 0)
      .addItemKey(r->wp_customer_sk)
      .addItem(r->wp_url)
      .addItem(r->wp_type)
      .addItem(r->wp_char_count)
      .addItem(r->wp_link_count)
      .addItem(r->wp_image_count)
      .addItem(r->wp_max_ad_count)
      .end();
