...
int mk_w_customer_demographics(void *info_arr, ds_key_t index) {
  ...
  loader.start()
      .addItemKey(r->cd_demo_sk)
      .addItem(r->cd_gender)
      .addItem(r->cd_marital_status)
      .addItem(r->cd_education_status)
      .addItem(r->cd_purchase_estimate)
      .addItem(r->cd_credit_rating)
      .addItem(r->cd_dep_count)
      .addItem(r->cd_dep_employed_count)
      .addItem(r->cd_dep_college_count)
      .end();
