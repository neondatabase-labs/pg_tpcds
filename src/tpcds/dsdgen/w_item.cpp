...
int mk_w_item(void *info_arr, ds_key_t index) {
  ...
  loader.start()
      .addItemKey(r->i_item_sk)
      .addItem(r->i_item_id)
      .addItemDate(r->i_rec_start_date_id)
      .addItemDate(r->i_rec_end_date_id)
      .addItem(r->i_item_desc)
      .addItemDecimal(r->i_current_price)
      .addItemDecimal(r->i_wholesale_cost)
      .addItemKey(r->i_brand_id)
      .addItem(r->i_brand)
      .addItemKey(r->i_class_id)
      .addItem(r->i_class)
      .addItemKey(r->i_category_id)
      .addItem(r->i_category)
      .addItemKey(r->i_manufact_id)
      .addItem(r->i_manufact)
      .addItem(r->i_size)
      .addItem(r->i_formulation)
      .addItem(r->i_color)
      .addItem(r->i_units)
      .addItem(r->i_container)
      .addItemKey(r->i_manager_id)
      .addItem(r->i_product_name)
      .end();
