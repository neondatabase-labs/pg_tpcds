...
static void mk_detail(void *info_arr, int bPrint) {
  ...
  if (nTemp < SR_RETURN_PCT) {
    ...
    auto &loader_store_returns = *(arr[1]);
    loader_store_returns.start()
        .addItemKey(rr->sr_returned_date_sk)
        .addItemKey(rr->sr_returned_time_sk)
        .addItemKey(rr->sr_item_sk)
        .addItemKey(rr->sr_customer_sk)
        .addItemKey(rr->sr_cdemo_sk)
        .addItemKey(rr->sr_hdemo_sk)
        .addItemKey(rr->sr_addr_sk)
        .addItemKey(rr->sr_store_sk)
        .addItemKey(rr->sr_reason_sk)
        .addItem(rr->sr_ticket_number)
        .addItem(rr->sr_pricing.quantity)
        .addItemDecimal(rr->sr_pricing.net_paid)
        .addItemDecimal(rr->sr_pricing.ext_tax)
        .addItemDecimal(rr->sr_pricing.net_paid_inc_tax)
        .addItemDecimal(rr->sr_pricing.fee)
        .addItemDecimal(rr->sr_pricing.ext_ship_cost)
        .addItemDecimal(rr->sr_pricing.refunded_cash)
        .addItemDecimal(rr->sr_pricing.reversed_charge)
        .addItemDecimal(rr->sr_pricing.store_credit)
        .addItemDecimal(rr->sr_pricing.net_loss)
        .end();
  }
  auto &loader_store_sales = *(arr[0]);

  loader_store_sales.start()
      .addItemKey(r->ss_sold_date_sk)
      .addItemKey(r->ss_sold_time_sk)
      .addItemKey(r->ss_sold_item_sk)
      .addItemKey(r->ss_sold_customer_sk)
      .addItemKey(r->ss_sold_cdemo_sk)
      .addItemKey(r->ss_sold_hdemo_sk)
      .addItemKey(r->ss_sold_addr_sk)
      .addItemKey(r->ss_sold_store_sk)
      .addItemKey(r->ss_sold_promo_sk)
      .addItem(r->ss_ticket_number)
      .addItem(r->ss_pricing.quantity)
      .addItemDecimal(r->ss_pricing.wholesale_cost)
      .addItemDecimal(r->ss_pricing.list_price)
      .addItemDecimal(r->ss_pricing.sales_price)
      .addItemDecimal(r->ss_pricing.coupon_amt)
      .addItemDecimal(r->ss_pricing.ext_sales_price)
      .addItemDecimal(r->ss_pricing.ext_wholesale_cost)
      .addItemDecimal(r->ss_pricing.ext_list_price)
      .addItemDecimal(r->ss_pricing.ext_tax)
      .addItemDecimal(r->ss_pricing.coupon_amt)
      .addItemDecimal(r->ss_pricing.net_paid)
      .addItemDecimal(r->ss_pricing.net_paid_inc_tax)
      .addItemDecimal(r->ss_pricing.net_profit)
      .end();
