...
int mk_w_customer(void *info_arr, ds_key_t index) {
  ...
  loader.start()
      .addItemKey(r->c_customer_sk)
      .addItem(r->c_customer_id)
      .addItemKey(r->c_current_cdemo_sk)
      .addItemKey(r->c_current_hdemo_sk)
      .addItemKey(r->c_current_addr_sk)
      .addItem(r->c_first_shipto_date_id)
      .addItem(r->c_first_sales_date_id)
      .addItem(r->c_salutation)
      .addItem(r->c_first_name)
      .addItem(r->c_last_name)
      .addItem(r->c_preferred_cust_flag ? "Y" : "N")
      .addItem(r->c_birth_day)
      .addItem(r->c_birth_month)
      .addItem(r->c_birth_year)
      .addItem(r->c_birth_country)
      .addItem(r->c_login)
      .addItem(r->c_email_address)
      .addItem(r->c_last_review_date)
      .end();
